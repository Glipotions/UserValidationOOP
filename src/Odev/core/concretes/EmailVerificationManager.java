...
public class EmailVerificationManager implements VerificationService{
	...
	public boolean verificate(User user) {
		...
		System.out.println(user.getEmail()
				+ " adresine bir doðrulama kodu gönderdik. Hesabýnýzý onaylamak istiyor musunuz? (E/H)");
		...
		if (chosenValue == 'e' || chosenValue == 'E') {
			...
			do {
				...
				if (count == 4) {
					System.out.println(
							"Çok sayýda hatalý denemnizden dolayý hesabýnýzý þu anda doðrulayamýyoruz.\nLütfen daha sonra tekrar deneyiniz..");
					scanner.close();
					return false;
				}

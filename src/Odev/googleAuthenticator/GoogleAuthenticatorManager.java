package Odev.googleAuthenticator;
...
public class GoogleAuthenticatorManager {
	...
	public boolean register(int id, String firstName, String lastName, String email, String password) {
		...
		System.out.println("Üyelik iþleminin tamamlanmasý için lütfen e-mail adresinize gelen maili kontrol ediniz.(Google ekibi)");
		return true;
	}
